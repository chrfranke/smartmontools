...
void ata_pass_through_debug_print(const ata_cmd_in & in, const char * devname, bool dump);

/// Print debug information for ATA pass-through output.
void ata_pass_through_debug_print(const ata_cmd_in & in, const ata_cmd_out & out,
